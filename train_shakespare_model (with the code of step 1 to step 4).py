...
Original file is located at
    https://colab.research.google.com/drive/1CarB9JAvGAZ6s-m8ffJT7HX6EOiDaVBP
"""
...
if not os.path.exists('generated_samples.txt'):
    print("Error: generated_samples.txt not found in /content/nanoGPT/. Please ensure Task 2 has been completed and the file exists.")
else:
